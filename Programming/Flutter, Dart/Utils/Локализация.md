Для имплементации в приложение лока используются зависимости *Intl* и *flutter_localization*. Все строки локализации записаны в файлах *app_ru.arb* и *app_en.arb* и по ним уже происходит генерация dart файлов, которые потом и используются в приложении.
